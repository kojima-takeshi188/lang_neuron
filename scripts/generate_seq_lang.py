...
def generate(args):
    ...
    """
    if args.model_name_or_path == "facebook/xglm-564M":
        tokenizer = XGLMTokenizer.from_pretrained(args.model_name_or_path, cache_dir=args.cache_dir)        
    else:
                ...
                for num_units in args.num_units:
                    ...
                    for seed in sweep_seed:
                        ...
                        if "translation_text_" in args.prompt:
                            """
                            target_lang = args.prompt.split("_")[-1].replace(".pkl", "")
                            if target_lang == 'fr':
                                target_lang = 'French'
                            elif target_lang == 'de':
                                target_lang = 'German'
                                ...
                                raise ValueError("error! target_lang is not properly defined!")
                            """
